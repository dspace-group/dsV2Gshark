...
static inline const char* get_enum_val_din_costKindType_reverse(int i)
{
...
static inline const char* get_enum_val_din_unitSymbolType_reverse(int i)
{
    if (i == 0) { return "h"; }
    if (i == 1) { return "m"; }
    if (i == 2) { return "s"; }
...
static inline const char* get_enum_val_din_serviceCategoryType_reverse(int i)
{
...
static inline const char* get_enum_val_din_isolationLevelType_reverse(int i)
{
...
static inline const char* get_enum_val_din_DC_EVSEStatusCodeType_reverse(int i)
{
...
static inline const char* get_enum_val_din_EVSESupportedEnergyTransferType_reverse(int i)
{
    ...
    if (i == 5) { return "DC_dual"; }
    if (i == 6) { return "AC_core1p_DC_extended"; }
    if (i == 7) { return "AC_single_DC_core"; }
    if (i == 8) { return "AC_single_phase_three_phase_core_DC_extended"; }
    if (i == 9) { return "AC_core3p_DC_extended"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_din_EVSENotificationType_reverse(int i)
{
    if (i == 0) { return "None"; }
...
static inline const char* get_enum_val_din_DC_EVErrorCodeType_reverse(int i)
{
...
static inline const char* get_enum_val_din_faultCodeType_reverse(int i)
{
...
static inline const char* get_enum_val_din_responseCodeType_reverse(int i)
{
    if (i == 0) { return "OK"; }
    ...
    if (i == 20) { return "FAILED_EVSEPresentVoltageToLow"; }
    if (i == 21) { return "FAILED_MeteringSignatureNotValid"; }
    if (i == 22) { return "FAILED_WrongEnergyTransferType"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_din_paymentOptionType_reverse(int i)
{
...
static inline const char* get_enum_val_din_EVRequestedEnergyTransferType_reverse(int i)
{
    if (i == 0) { return "AC_single_phase_core"; }
    if (i == 1) { return "AC_three_phase_core"; }
    if (i == 2) { return "DC_core"; }
...
static inline const char* get_enum_val_din_EVSEProcessingType_reverse(int i)
{
...
static inline const char* get_enum_val_din_valueType_reverse(int i)
{
    if (i == 0) { return "bool"; }
    if (i == 1) { return "byte"; }
    if (i == 2) { return "short"; }
    if (i == 3) { return "int"; }
    if (i == 4) { return "physicalValue"; }
