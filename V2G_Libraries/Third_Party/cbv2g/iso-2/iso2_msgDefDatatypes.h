...
#define iso2_PMaxScheduleEntryType_16_ARRAY_SIZE (16)
...
#define iso2_SalesTariffEntryType_16_ARRAY_SIZE (16)
...
#define iso2_ParameterSetType_21_ARRAY_SIZE (21)
...
static inline const char* get_enum_val_iso2_costKindType_reverse(int i)
{
    if (i == 0) { return "relativePricePercentage"; }
    if (i == 1) { return "RenewableGenerationPercentage"; }
    if (i == 2) { return "CarbonDioxideEmission"; }
...
static inline const char* get_enum_val_iso2_unitSymbolType_reverse(int i)
{
    if (i == 0) { return "h"; }
    if (i == 1) { return "m"; }
    if (i == 2) { return "s"; }
...
static inline const char* get_enum_val_iso2_EVSENotificationType_reverse(int i)
{
    if (i == 0) { return "None"; }
    if (i == 1) { return "StopCharging"; }
    if (i == 2) { return "ReNegotiation"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_DC_EVErrorCodeType_reverse(int i)
{
    if (i == 0) { return "NO_ERROR"; }
    if (i == 1) { return "FAILED_RESSTemperatureInhibit"; }
    if (i == 2) { return "FAILED_EVShiftPosition"; }
    if (i == 3) { return "FAILED_ChargerConnectorLockFault"; }
    if (i == 4) { return "FAILED_EVRESSMalfunction"; }
    if (i == 5) { return "FAILED_ChargingCurrentdifferential"; }
    if (i == 6) { return "FAILED_ChargingVoltageOutOfRange"; }
    if (i == 7) { return "Reserved_A"; }
    if (i == 8) { return "Reserved_B"; }
    if (i == 9) { return "Reserved_C"; }
    if (i == 10) { return "FAILED_ChargingSystemIncompatibility"; }
    if (i == 11) { return "NoData"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_isolationLevelType_reverse(int i)
{
    if (i == 0) { return "Invalid"; }
    if (i == 1) { return "Valid"; }
    if (i == 2) { return "Warning"; }
    if (i == 3) { return "Fault"; }
    if (i == 4) { return "No_IMD"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_DC_EVSEStatusCodeType_reverse(int i)
{
    if (i == 0) { return "EVSE_NotReady"; }
    if (i == 1) { return "EVSE_Ready"; }
    if (i == 2) { return "EVSE_Shutdown"; }
    if (i == 3) { return "EVSE_UtilityInterruptEvent"; }
    if (i == 4) { return "EVSE_IsolationMonitoringActive"; }
    if (i == 5) { return "EVSE_EmergencyShutdown"; }
    if (i == 6) { return "EVSE_Malfunction"; }
    if (i == 7) { return "Reserved_8"; }
    if (i == 8) { return "Reserved_9"; }
    if (i == 9) { return "Reserved_A"; }
    if (i == 10) { return "Reserved_B"; }
    if (i == 11) { return "Reserved_C"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_faultCodeType_reverse(int i)
{
    if (i == 0) { return "ParsingError"; }
    if (i == 1) { return "NoTLSRootCertificatAvailable"; }
    if (i == 2) { return "UnknownError"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_responseCodeType_reverse(int i)
{
    if (i == 0) { return "OK"; }
    if (i == 1) { return "OK_NewSessionEstablished"; }
    if (i == 2) { return "OK_OldSessionJoined"; }
    if (i == 3) { return "OK_CertificateExpiresSoon"; }
    if (i == 4) { return "FAILED"; }
    if (i == 5) { return "FAILED_SequenceError"; }
    if (i == 6) { return "FAILED_ServiceIDInvalid"; }
    if (i == 7) { return "FAILED_UnknownSession"; }
    if (i == 8) { return "FAILED_ServiceSelectionInvalid"; }
    if (i == 9) { return "FAILED_PaymentSelectionInvalid"; }
    if (i == 10) { return "FAILED_CertificateExpired"; }
    if (i == 11) { return "FAILED_SignatureError"; }
    if (i == 12) { return "FAILED_NoCertificateAvailable"; }
    if (i == 13) { return "FAILED_CertChainError"; }
    if (i == 14) { return "FAILED_ChallengeInvalid"; }
    if (i == 15) { return "FAILED_ContractCanceled"; }
    if (i == 16) { return "FAILED_WrongChargeParameter"; }
    if (i == 17) { return "FAILED_PowerDeliveryNotApplied"; }
    if (i == 18) { return "FAILED_TariffSelectionInvalid"; }
    if (i == 19) { return "FAILED_ChargingProfileInvalid"; }
    if (i == 20) { return "FAILED_MeteringSignatureNotValid"; }
    if (i == 21) { return "FAILED_NoChargeServiceSelected"; }
    if (i == 22) { return "FAILED_WrongEnergyTransferMode"; }
    if (i == 23) { return "FAILED_ContactorError"; }
    if (i == 24) { return "FAILED_CertificateNotAllowedAtThisEVSE"; }
    if (i == 25) { return "FAILED_CertificateRevoked"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_paymentOptionType_reverse(int i)
{
    if (i == 0) { return "Contract"; }
    if (i == 1) { return "ExternalPayment"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_chargingSessionType_reverse(int i)
{
    if (i == 0) { return "Terminate"; }
    if (i == 1) { return "Pause"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_chargeProgressType_reverse(int i)
{
    if (i == 0) { return "Start"; }
    if (i == 1) { return "Stop"; }
    if (i == 2) { return "Renegotiate"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_EVSEProcessingType_reverse(int i)
{
...
static inline const char* get_enum_val_iso2_serviceCategoryType_reverse(int i)
{
    if (i == 0) { return "EVCharging"; }
    if (i == 1) { return "Internet"; }
    if (i == 2) { return "ContractCertificate"; }
    if (i == 3) { return "OtherCustom"; }
    return "ENUM DECODING ERROR";
}
...
static inline const char* get_enum_val_iso2_EnergyTransferModeType_reverse(int i)
{
    if (i == 0) { return "AC_single_phase_core"; }
    if (i == 1) { return "AC_three_phase_core"; }
    if (i == 2) { return "DC_core"; }
    if (i == 3) { return "DC_extended"; }
    if (i == 4) { return "DC_combo_core"; }
    if (i == 5) { return "DC_unique"; }
    return "ENUM DECODING ERROR";
}
...
struct iso2_PMaxScheduleType {
    ...
    struct {
        struct iso2_PMaxScheduleEntryType array[iso2_PMaxScheduleEntryType_16_ARRAY_SIZE];
        uint16_t arrayLen;
    } PMaxScheduleEntry;
};
...
struct iso2_SalesTariffType {
    ...
    struct {
        struct iso2_SalesTariffEntryType array[iso2_SalesTariffEntryType_16_ARRAY_SIZE];
        uint16_t arrayLen;
    } SalesTariffEntry;
};
...
struct iso2_ServiceParameterListType {
    ...
    struct {
        struct iso2_ParameterSetType array[iso2_ParameterSetType_21_ARRAY_SIZE];
        uint16_t arrayLen;
    } ParameterSet;
};
