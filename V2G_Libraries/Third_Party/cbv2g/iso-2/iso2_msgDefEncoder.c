...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}PMax; type={urn:iso:15118:2:2013:MsgDataTypes}PhysicalValueType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_PhysicalValueType(exi_bitstream_t* stream, const struct iso2_PhysicalValueType* PhysicalValueType) {
    ...
    while (!done)
    {
        ...
        {
        case 7:
            // Grammar: ID=7; read/write bits=1; START (Multiplier)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (byte); next=8
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 8:
            // Grammar: ID=8; read/write bits=1; START (Unit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=9
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 9:
            // Grammar: ID=9; read/write bits=1; START (Value)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_ConsumptionCostType(exi_bitstream_t* stream, const struct iso2_ConsumptionCostType* ConsumptionCostType) {
    ...
    while (!done)
    {
        ...
        {
        case 10:
            // Grammar: ID=10; read/write bits=1; START (startValue)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=11
            ...
            break;
        case 11:
            // Grammar: ID=11; read/write bits=1; START (Cost)
            if (Cost_currentIndex < ConsumptionCostType->Cost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CostType); next=12
            ...
            break;
        case 12:
            // Grammar: ID=12; read/write bits=2; LOOP (Cost), END Element
            if (Cost_currentIndex < ConsumptionCostType->Cost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (CostType); next=12
                    error = encode_iso2_CostType(stream, &ConsumptionCostType->Cost.array[Cost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 12;
...
static int encode_iso2_TransformsType(exi_bitstream_t* stream, const struct iso2_TransformsType* TransformsType) {
    ...
    while (!done)
    {
        ...
        {
        case 13:
            // Grammar: ID=13; read/write bits=1; START (Transform)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (TransformType); next=14
            ...
            break;
        case 14:
            // Grammar: ID=14; read/write bits=2; START (Transform), END Element
            if (1 == 0)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
...
static int encode_iso2_DSAKeyValueType(exi_bitstream_t* stream, const struct iso2_DSAKeyValueType* DSAKeyValueType) {
    ...
    while (!done)
    {
        ...
        {
        case 15:
            // Grammar: ID=15; read/write bits=2; START (P), START (G), START (Y)
            if (DSAKeyValueType->P_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (P, base64Binary); next=16
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (DSAKeyValueType->G_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (G, base64Binary); next=18
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Y, base64Binary); next=19
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 16:
            // Grammar: ID=16; read/write bits=1; START (Q)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 17:
            // Grammar: ID=17; read/write bits=2; START (G), START (Y)
            ...
            break;
        case 18:
            // Grammar: ID=18; read/write bits=1; START (Y)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=19
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_uint_16(stream, (uint16_t)DSAKeyValueType->Y.bytesLen);
            ...
            break;
        case 19:
            // Grammar: ID=19; read/write bits=2; START (J), START (Seed), END Element
            if (DSAKeyValueType->J_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (J, base64Binary); next=20
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (DSAKeyValueType->Seed_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Seed, base64Binary); next=21
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 20:
            // Grammar: ID=20; read/write bits=2; START (Seed), END Element
            ...
            break;
        case 21:
            // Grammar: ID=21; read/write bits=2; START (PgenCounter), END Element
...
static int encode_iso2_X509IssuerSerialType(exi_bitstream_t* stream, const struct iso2_X509IssuerSerialType* X509IssuerSerialType) {
    ...
    while (!done)
    {
        ...
        {
        case 22:
            // Grammar: ID=22; read/write bits=1; START (X509IssuerName)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=23
            ...
            break;
        case 23:
            // Grammar: ID=23; read/write bits=1; START (X509SerialNumber)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_RelativeTimeIntervalType(exi_bitstream_t* stream, const struct iso2_RelativeTimeIntervalType* RelativeTimeIntervalType) {
    ...
    while (!done)
    {
        ...
        {
        case 24:
            // Grammar: ID=24; read/write bits=1; START (start)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=25
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 25:
            // Grammar: ID=25; read/write bits=2; START (duration), END Element
...
static int encode_iso2_PMaxScheduleEntryType(exi_bitstream_t* stream, const struct iso2_PMaxScheduleEntryType* PMaxScheduleEntryType) {
    ...
    while (!done)
    {
        ...
        {
        case 26:
            // Grammar: ID=26; read/write bits=2; START (RelativeTimeInterval), START (TimeInterval)
            if (PMaxScheduleEntryType->RelativeTimeInterval_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RelativeTimeInterval, IntervalType); next=27
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (IntervalType); next=27
            ...
            break;
        case 27:
            // Grammar: ID=27; read/write bits=1; START (PMax)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_DigestMethodType(exi_bitstream_t* stream, const struct iso2_DigestMethodType* DigestMethodType) {
    ...
    while (!done)
    {
        ...
        {
        case 28:
            // Grammar: ID=28; read/write bits=1; START (Algorithm)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (anyURI); next=29
            ...
            break;
        case 29:
            // Grammar: ID=29; read/write bits=2; START (ANY), END Element, START (ANY)
            // ***** //
            //{
...
static int encode_iso2_RSAKeyValueType(exi_bitstream_t* stream, const struct iso2_RSAKeyValueType* RSAKeyValueType) {
    ...
    while (!done)
    {
        ...
        {
        case 30:
            // Grammar: ID=30; read/write bits=1; START (Modulus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=31
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 31:
            // Grammar: ID=31; read/write bits=1; START (Exponent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_SalesTariffEntryType(exi_bitstream_t* stream, const struct iso2_SalesTariffEntryType* SalesTariffEntryType) {
    ...
    while (!done)
    {
        ...
        {
        case 32:
            // Grammar: ID=32; read/write bits=2; START (RelativeTimeInterval), START (TimeInterval)
            if (SalesTariffEntryType->RelativeTimeInterval_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RelativeTimeInterval, IntervalType); next=33
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (IntervalType); next=33
            ...
            break;
        case 33:
            // Grammar: ID=33; read/write bits=2; START (EPriceLevel), START (ConsumptionCost), END Element
            if (SalesTariffEntryType->EPriceLevel_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EPriceLevel, unsignedShort); next=35
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ConsumptionCost, ConsumptionCostType); next=34 (optional array)
            ...
            break;
        case 34:
            // Grammar: ID=34; read/write bits=2; LOOP (ConsumptionCost), END Element
            if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ConsumptionCost, ConsumptionCostType); next=34 (optional array)
                    error = encode_iso2_ConsumptionCostType(stream, &SalesTariffEntryType->ConsumptionCost.array[ConsumptionCost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 34;
        ...
        case 35:
            ...
            break;
        case 36:
            // Grammar: ID=36; read/write bits=2; LOOP (ConsumptionCost), END Element
            if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ConsumptionCost, ConsumptionCostType); next=36 (optional array)
                    error = encode_iso2_ConsumptionCostType(stream, &SalesTariffEntryType->ConsumptionCost.array[ConsumptionCost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 36;
...
static int encode_iso2_CanonicalizationMethodType(exi_bitstream_t* stream, const struct iso2_CanonicalizationMethodType* CanonicalizationMethodType) {
    ...
    while (!done)
    {
        ...
        {
        case 37:
            // Grammar: ID=37; read/write bits=1; START (Algorithm)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (anyURI); next=38
            ...
            break;
        case 38:
            // Grammar: ID=38; read/write bits=2; START (ANY), END Element, START (ANY)
            // ***** //
            //{
                // No code for unsupported generic event: ANY (index=0)
            //{
...
static int encode_iso2_SignatureMethodType(exi_bitstream_t* stream, const struct iso2_SignatureMethodType* SignatureMethodType) {
    ...
    while (!done)
    {
        ...
        {
        case 39:
            // Grammar: ID=39; read/write bits=1; START (Algorithm)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (anyURI); next=40
            ...
            break;
        case 40:
            // Grammar: ID=40; read/write bits=3; START (HMACOutputLength), START (ANY), END Element, START (ANY)
            if (SignatureMethodType->HMACOutputLength_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (HMACOutputLength, integer); next=41
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_KeyValueType(exi_bitstream_t* stream, const struct iso2_KeyValueType* KeyValueType) {
    ...
    while (!done)
    {
        ...
        {
        case 42:
            // Grammar: ID=42; read/write bits=2; START (DSAKeyValue), START (RSAKeyValue), START (ANY)
...
//          abstract=False; final=False;
// Particle: PMaxScheduleEntry, PMaxScheduleEntryType (1, 16) (original max 1024);
static int encode_iso2_PMaxScheduleType(exi_bitstream_t* stream, const struct iso2_PMaxScheduleType* PMaxScheduleType) {
    int grammar_id = 43;
    int done = 0;
    int error = 0;
    ...
    while (!done)
    {
        ...
        {
        case 43:
            // Grammar: ID=43; read/write bits=1; START (PMaxScheduleEntry)
            ...
            break;
        case 44:
            // Grammar: ID=44; read/write bits=2; LOOP (PMaxScheduleEntry), END Element
            if (PMaxScheduleEntry_currentIndex < PMaxScheduleType->PMaxScheduleEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (EntryType); next=44
                    error = encode_iso2_PMaxScheduleEntryType(stream, &PMaxScheduleType->PMaxScheduleEntry.array[PMaxScheduleEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 44;
...
static int encode_iso2_ParameterType(exi_bitstream_t* stream, const struct iso2_ParameterType* ParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 45:
            // Grammar: ID=45; read/write bits=1; START (Name)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 46:
            // Grammar: ID=46; read/write bits=3; START (boolValue), START (byteValue), START (shortValue), START (intValue), START (physicalValue), START (stringValue)
...
//          abstract=False; final=False;
// Particle: Id, ID (0, 1); SalesTariffID, SAIDType (1, 1); SalesTariffDescription, tariffDescriptionType (0, 1); NumEPriceLevels, unsignedByte (0, 1); SalesTariffEntry, SalesTariffEntryType (1, 16) (original max 1024);
static int encode_iso2_SalesTariffType(exi_bitstream_t* stream, const struct iso2_SalesTariffType* SalesTariffType) {
    int grammar_id = 56;
    int done = 0;
    int error = 0;
...
static int encode_iso2_SAScheduleTupleType(exi_bitstream_t* stream, const struct iso2_SAScheduleTupleType* SAScheduleTupleType) {
    ...
    while (!done)
    {
        ...
        {
        case 77:
            // Grammar: ID=77; read/write bits=1; START (SAScheduleTupleID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=78
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 78:
            // Grammar: ID=78; read/write bits=1; START (PMaxSchedule)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PMaxScheduleType); next=79
            ...
            break;
        case 79:
            // Grammar: ID=79; read/write bits=2; START (SalesTariff), END Element
...
static int encode_iso2_DC_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_DC_EVSEStatusType* DC_EVSEStatusType) {
    ...
    while (!done)
    {
        ...
        {
        case 80:
            // Grammar: ID=80; read/write bits=1; START (NotificationMaxDelay)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 81:
            // Grammar: ID=81; read/write bits=1; START (EVSENotification)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 82:
            // Grammar: ID=82; read/write bits=2; START (EVSEIsolationStatus), START (EVSEStatusCode)
            if (DC_EVSEStatusType->EVSEIsolationStatus_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEIsolationStatus, string); next=83
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 83:
            // Grammar: ID=83; read/write bits=1; START (EVSEStatusCode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_AC_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_AC_EVSEStatusType* AC_EVSEStatusType) {
    ...
    while (!done)
    {
        ...
        {
        case 84:
            // Grammar: ID=84; read/write bits=1; START (NotificationMaxDelay)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=85
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 85:
            // Grammar: ID=85; read/write bits=1; START (EVSENotification)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 86:
            // Grammar: ID=86; read/write bits=1; START (RCD)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_ParameterSetType(exi_bitstream_t* stream, const struct iso2_ParameterSetType* ParameterSetType) {
    ...
    while (!done)
    {
        ...
        {
        case 87:
            // Grammar: ID=87; read/write bits=1; START (ParameterSetID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 88:
            // Grammar: ID=88; read/write bits=1; START (Parameter)
            ...
            break;
        case 89:
            // Grammar: ID=89; read/write bits=2; LOOP (Parameter), END Element
            if (Parameter_currentIndex < ParameterSetType->Parameter.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ParameterType); next=89
                    error = encode_iso2_ParameterType(stream, &ParameterSetType->Parameter.array[Parameter_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 89;
...
static int encode_iso2_SelectedServiceType(exi_bitstream_t* stream, const struct iso2_SelectedServiceType* SelectedServiceType) {
    ...
    while (!done)
    {
        ...
        {
        case 90:
            // Grammar: ID=90; read/write bits=1; START (ServiceID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 91:
            // Grammar: ID=91; read/write bits=2; START (ParameterSetID), END Element
...
static int encode_iso2_ServiceType(exi_bitstream_t* stream, const struct iso2_ServiceType* ServiceType) {
    ...
    while (!done)
    {
        ...
        {
        case 92:
            // Grammar: ID=92; read/write bits=1; START (ServiceID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 93:
            // Grammar: ID=93; read/write bits=2; START (ServiceName), START (ServiceCategory)
            if (ServiceType->ServiceName_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceName, string); next=94
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceCategory, string); next=95
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 94:
            // Grammar: ID=94; read/write bits=1; START (ServiceCategory)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 95:
            // Grammar: ID=95; read/write bits=2; START (ServiceScope), START (FreeService)
            if (ServiceType->ServiceScope_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=96
            ...
            break;
        case 96:
            // Grammar: ID=96; read/write bits=1; START (FreeService)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=3
...
static int encode_iso2_ProfileEntryType(exi_bitstream_t* stream, const struct iso2_ProfileEntryType* ProfileEntryType) {
    ...
    while (!done)
    {
        ...
        {
        case 97:
            // Grammar: ID=97; read/write bits=1; START (ChargingProfileEntryStart)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedLong); next=98
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 98:
            // Grammar: ID=98; read/write bits=1; START (ChargingProfileEntryMaxPower)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=99
            ...
            break;
        case 99:
            // Grammar: ID=99; read/write bits=2; START (ChargingProfileEntryMaxNumberOfPhasesInUse), END Element
...
static int encode_iso2_KeyInfoType(exi_bitstream_t* stream, const struct iso2_KeyInfoType* KeyInfoType) {
    ...
    while (!done)
    {
        ...
        {
        case 107:
            // Grammar: ID=107; read/write bits=4; START (Id), START (KeyName), START (KeyValue), START (RetrievalMethod), START (X509Data), START (PGPData), START (SPKIData), START (MgmtData), START (ANY)
            ...
            break;
        case 108:
            // Grammar: ID=108; read/write bits=4; START (KeyName), START (KeyValue), START (RetrievalMethod), START (X509Data), START (PGPData), START (SPKIData), START (MgmtData), START (ANY)
...
static int encode_iso2_ObjectType(exi_bitstream_t* stream, const struct iso2_ObjectType* ObjectType) {
    ...
    while (!done)
    {
        ...
        {
        case 109:
            // Grammar: ID=109; read/write bits=3; START (Encoding), START (Id), START (MimeType), START (ANY), END Element, START (ANY)
            if (ObjectType->Encoding_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Encoding, anyURI); next=110
            ...
            else if (ObjectType->MimeType_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MimeType, string); next=112
            ...
            break;
        case 110:
            // Grammar: ID=110; read/write bits=3; START (Id), START (MimeType), START (ANY), END Element, START (ANY)
            ...
            break;
        case 111:
            // Grammar: ID=111; read/write bits=3; START (MimeType), START (ANY), END Element, START (ANY)
            ...
            break;
        case 112:
            // Grammar: ID=112; read/write bits=2; START (ANY), END Element, START (ANY)
            // ***** //
            //{
                // No code for unsupported generic event: ANY (index=0)
            //{
...
static int encode_iso2_SupportedEnergyTransferModeType(exi_bitstream_t* stream, const struct iso2_SupportedEnergyTransferModeType* SupportedEnergyTransferModeType) {
    ...
    while (!done)
    {
        ...
        {
        case 113:
            // Grammar: ID=113; read/write bits=1; START (EnergyTransferMode)
            ...
            break;
        case 114:
            // Grammar: ID=114; read/write bits=2; LOOP (EnergyTransferMode), END Element
            if (EnergyTransferMode_currentIndex < SupportedEnergyTransferModeType->EnergyTransferMode.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (string); next=114
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_nbit_uint(stream, 3, SupportedEnergyTransferModeType->EnergyTransferMode.array[EnergyTransferMode_currentIndex++]);
...
static int encode_iso2_NotificationType(exi_bitstream_t* stream, const struct iso2_NotificationType* NotificationType) {
    ...
    while (!done)
    {
        ...
        {
        case 115:
            // Grammar: ID=115; read/write bits=1; START (FaultCode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 116:
            // Grammar: ID=116; read/write bits=2; START (FaultMsg), END Element
...
static int encode_iso2_CertificateChainType(exi_bitstream_t* stream, const struct iso2_CertificateChainType* CertificateChainType) {
    ...
    while (!done)
    {
        ...
        {
        case 117:
            // Grammar: ID=117; read/write bits=2; START (Id), START (Certificate)
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Certificate, base64Binary); next=119
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 118:
            // Grammar: ID=118; read/write bits=1; START (Certificate)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 119:
            // Grammar: ID=119; read/write bits=2; START (SubCertificates), END Element
...
static int encode_iso2_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_EVSEStatusType* EVSEStatusType) {
    ...
    while (!done)
    {
        ...
        {
        case 120:
            // Grammar: ID=120; read/write bits=1; START (NotificationMaxDelay)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=121
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 121:
            // Grammar: ID=121; read/write bits=1; START (EVSENotification)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 122:
            // Grammar: ID=122; read/write bits=1; START (AC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=123
            ...
            break;
        case 123:
            // Grammar: ID=123; read/write bits=1; START (DC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_SelectedServiceListType(exi_bitstream_t* stream, const struct iso2_SelectedServiceListType* SelectedServiceListType) {
    ...
    while (!done)
    {
        ...
        {
        case 124:
            // Grammar: ID=124; read/write bits=1; START (SelectedService)
            ...
            break;
        case 125:
            // Grammar: ID=125; read/write bits=2; LOOP (SelectedService), END Element
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (SelectedServiceType); next=125
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 125;
...
static int encode_iso2_PaymentOptionListType(exi_bitstream_t* stream, const struct iso2_PaymentOptionListType* PaymentOptionListType) {
    ...
    while (!done)
    {
        ...
        {
        case 126:
            // Grammar: ID=126; read/write bits=1; START (PaymentOption)
            ...
            break;
        case 127:
            // Grammar: ID=127; read/write bits=2; START (PaymentOption), END Element
            if (PaymentOption_currentIndex < PaymentOptionListType->PaymentOption.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
...
static int encode_iso2_ListOfRootCertificateIDsType(exi_bitstream_t* stream, const struct iso2_ListOfRootCertificateIDsType* ListOfRootCertificateIDsType) {
    ...
    while (!done)
    {
        ...
        {
        case 128:
            // Grammar: ID=128; read/write bits=1; START (RootCertificateID)
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (X509IssuerSerialType); next=129
            ...
            break;
        case 129:
            // Grammar: ID=129; read/write bits=2; LOOP (RootCertificateID), END Element
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (X509IssuerSerialType); next=129
                    error = encode_iso2_X509IssuerSerialType(stream, &ListOfRootCertificateIDsType->RootCertificateID.array[RootCertificateID_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 129;
...
static int encode_iso2_SignatureType(exi_bitstream_t* stream, const struct iso2_SignatureType* SignatureType) {
    ...
    while (!done)
    {
        ...
        {
        case 130:
            // Grammar: ID=130; read/write bits=2; START (Id), START (SignedInfo)
            if (SignatureType->Id_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=131
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SignedInfo, SignedInfoType); next=132
            ...
            break;
        case 131:
            // Grammar: ID=131; read/write bits=1; START (SignedInfo)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (SignedInfoType); next=132
                error = encode_iso2_SignedInfoType(stream, &SignatureType->SignedInfo);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 132;
            ...
            break;
        case 132:
            // Grammar: ID=132; read/write bits=1; START (SignatureValue)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=133
            ...
            break;
        case 133:
            // Grammar: ID=133; read/write bits=2; START (KeyInfo), START (Object), END Element
            if (SignatureType->KeyInfo_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (KeyInfo, KeyInfoType); next=135
            ...
            else if (SignatureType->Object_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Object, ObjectType); next=134
        ...
        case 135:
            ...
            if (SignatureType->Object_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Object, ObjectType); next=136
                    error = encode_iso2_ObjectType(stream, &SignatureType->Object);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 136;
            ...
            break;
        case 136:
            // Grammar: ID=136; read/write bits=2; START (Object), END Element
            if (1 == 0)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
...
static int encode_iso2_SAScheduleListType(exi_bitstream_t* stream, const struct iso2_SAScheduleListType* SAScheduleListType) {
    ...
    while (!done)
    {
        ...
        {
        case 137:
            // Grammar: ID=137; read/write bits=1; START (SAScheduleTuple)
            if (SAScheduleTuple_currentIndex < SAScheduleListType->SAScheduleTuple.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleTupleType); next=138
            ...
            break;
        case 138:
            // Grammar: ID=138; read/write bits=2; LOOP (SAScheduleTuple), END Element
            if (SAScheduleTuple_currentIndex < SAScheduleListType->SAScheduleTuple.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (SAScheduleTupleType); next=138
                    error = encode_iso2_SAScheduleTupleType(stream, &SAScheduleListType->SAScheduleTuple.array[SAScheduleTuple_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 138;
...
//          abstract=False; final=False;
// Particle: ParameterSet, ParameterSetType (1, 21) (original max 255);
static int encode_iso2_ServiceParameterListType(exi_bitstream_t* stream, const struct iso2_ServiceParameterListType* ServiceParameterListType) {
    int grammar_id = 139;
    int done = 0;
    int error = 0;
    ...
    while (!done)
    {
        ...
        {
        case 139:
            // Grammar: ID=139; read/write bits=1; START (ParameterSet)
            if (ParameterSet_currentIndex < ServiceParameterListType->ParameterSet.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ParameterSetType); next=140
            ...
            break;
        case 140:
            // Grammar: ID=140; read/write bits=2; LOOP (ParameterSet), END Element
            if (ParameterSet_currentIndex < ServiceParameterListType->ParameterSet.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ParameterSetType); next=140
                    error = encode_iso2_ParameterSetType(stream, &ServiceParameterListType->ParameterSet.array[ParameterSet_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 140;
...
static int encode_iso2_DC_EVChargeParameterType(exi_bitstream_t* stream, const struct iso2_DC_EVChargeParameterType* DC_EVChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 141:
            // Grammar: ID=141; read/write bits=2; START (DepartureTime), START (DC_EVStatus)
            if (DC_EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=142
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DC_EVStatus, EVStatusType); next=143
        ...
        case 142:
            ...
            break;
        case 143:
            // Grammar: ID=143; read/write bits=1; START (EVMaximumCurrentLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 144:
            // Grammar: ID=144; read/write bits=2; START (EVMaximumPowerLimit), START (EVMaximumVoltageLimit)
            if (DC_EVChargeParameterType->EVMaximumPowerLimit_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumPowerLimit, PhysicalValueType); next=145
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumVoltageLimit, PhysicalValueType); next=146
            ...
            break;
        case 145:
            // Grammar: ID=145; read/write bits=1; START (EVMaximumVoltageLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=146
                error = encode_iso2_PhysicalValueType(stream, &DC_EVChargeParameterType->EVMaximumVoltageLimit);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 146;
            ...
            break;
        case 146:
            // Grammar: ID=146; read/write bits=3; START (EVEnergyCapacity), START (EVEnergyRequest), START (FullSOC), START (BulkSOC), END Element
            if (DC_EVChargeParameterType->EVEnergyCapacity_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVEnergyCapacity, PhysicalValueType); next=147
            ...
            else if (DC_EVChargeParameterType->EVEnergyRequest_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVEnergyRequest, PhysicalValueType); next=148
            ...
            else if (DC_EVChargeParameterType->FullSOC_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (FullSOC, byte); next=149
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 147:
            // Grammar: ID=147; read/write bits=3; START (EVEnergyRequest), START (FullSOC), START (BulkSOC), END Element
            ...
            break;
        case 148:
            // Grammar: ID=148; read/write bits=2; START (FullSOC), START (BulkSOC), END Element
            ...
            break;
        case 149:
            // Grammar: ID=149; read/write bits=2; START (BulkSOC), END Element
...
static int encode_iso2_AC_EVChargeParameterType(exi_bitstream_t* stream, const struct iso2_AC_EVChargeParameterType* AC_EVChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 150:
            // Grammar: ID=150; read/write bits=2; START (DepartureTime), START (EAmount)
            if (AC_EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=151
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EAmount, PhysicalValueType); next=152
            ...
            break;
        case 151:
            // Grammar: ID=151; read/write bits=1; START (EAmount)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 152:
            // Grammar: ID=152; read/write bits=1; START (EVMaxVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 153:
            // Grammar: ID=153; read/write bits=1; START (EVMaxCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 154:
            // Grammar: ID=154; read/write bits=1; START (EVMinCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
static int encode_iso2_EVChargeParameterType(exi_bitstream_t* stream, const struct iso2_EVChargeParameterType* EVChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 155:
            // Grammar: ID=155; read/write bits=2; START (DepartureTime), START (DC_EVChargeParameter)
            if (EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=156
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DC_EVChargeParameter, EVChargeParameterType); next=157
            ...
            break;
        case 156:
            // Grammar: ID=156; read/write bits=1; START (DC_EVChargeParameter)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVChargeParameterType); next=157
                error = encode_iso2_DC_EVChargeParameterType(stream, &EVChargeParameterType->DC_EVChargeParameter);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 157;
            ...
            break;
        case 157:
            // Grammar: ID=157; read/write bits=1; START (AC_EVChargeParameter)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_ChargeServiceType(exi_bitstream_t* stream, const struct iso2_ChargeServiceType* ChargeServiceType) {
    ...
    while (!done)
    {
        ...
        {
        case 158:
            // Grammar: ID=158; read/write bits=1; START (ServiceID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedShort); next=159
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 159:
            // Grammar: ID=159; read/write bits=2; START (ServiceName), START (ServiceCategory)
            if (ChargeServiceType->ServiceName_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceName, string); next=160
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceCategory, string); next=161
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 160:
            // Grammar: ID=160; read/write bits=1; START (ServiceCategory)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 161:
            // Grammar: ID=161; read/write bits=2; START (ServiceScope), START (FreeService)
            if (ChargeServiceType->ServiceScope_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=162
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (FreeService, boolean); next=163
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 162:
            // Grammar: ID=162; read/write bits=1; START (FreeService)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 163:
            // Grammar: ID=163; read/write bits=1; START (SupportedEnergyTransferMode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
    ...
    while (!done)
    {
        ...
        case 165:
            ...
            if (MeterInfoType->MeterReading_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterReading, nonNegativeInteger); next=166
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_ChargingProfileType(exi_bitstream_t* stream, const struct iso2_ChargingProfileType* ChargingProfileType) {
    ...
    while (!done)
    {
        ...
        {
        case 169:
            // Grammar: ID=169; read/write bits=1; START (ProfileEntry)
            ...
            break;
        case 170:
            // Grammar: ID=170; read/write bits=2; LOOP (ProfileEntry), END Element
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ProfileEntryType); next=170
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 170;
...
static int encode_iso2_DC_EVSEChargeParameterType(exi_bitstream_t* stream, const struct iso2_DC_EVSEChargeParameterType* DC_EVSEChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 171:
            // Grammar: ID=171; read/write bits=1; START (DC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=172
            ...
            break;
        case 172:
            // Grammar: ID=172; read/write bits=1; START (EVSEMaximumCurrentLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=173
            ...
            break;
        case 173:
            // Grammar: ID=173; read/write bits=1; START (EVSEMaximumPowerLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=174
            ...
            break;
        case 174:
            // Grammar: ID=174; read/write bits=1; START (EVSEMaximumVoltageLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 175:
            // Grammar: ID=175; read/write bits=1; START (EVSEMinimumCurrentLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=176
            ...
            break;
        case 176:
            // Grammar: ID=176; read/write bits=1; START (EVSEMinimumVoltageLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=177
            ...
            break;
        case 177:
            // Grammar: ID=177; read/write bits=2; START (EVSECurrentRegulationTolerance), START (EVSEPeakCurrentRipple)
            if (DC_EVSEChargeParameterType->EVSECurrentRegulationTolerance_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSECurrentRegulationTolerance, PhysicalValueType); next=178
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEPeakCurrentRipple, PhysicalValueType); next=179
            ...
            break;
        case 178:
            // Grammar: ID=178; read/write bits=1; START (EVSEPeakCurrentRipple)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 179:
            // Grammar: ID=179; read/write bits=2; START (EVSEEnergyToBeDelivered), END Element
...
static int encode_iso2_AC_EVSEChargeParameterType(exi_bitstream_t* stream, const struct iso2_AC_EVSEChargeParameterType* AC_EVSEChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 180:
            // Grammar: ID=180; read/write bits=1; START (AC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=181
            ...
            break;
        case 181:
            // Grammar: ID=181; read/write bits=1; START (EVSENominalVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 182:
            // Grammar: ID=182; read/write bits=1; START (EVSEMaxCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
static int encode_iso2_ServiceListType(exi_bitstream_t* stream, const struct iso2_ServiceListType* ServiceListType) {
    ...
    while (!done)
    {
        ...
        {
        case 183:
            // Grammar: ID=183; read/write bits=1; START (Service)
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=184
            ...
            break;
        case 184:
            // Grammar: ID=184; read/write bits=2; LOOP (Service), END Element
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ServiceType); next=184
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 184;
...
static int encode_iso2_ChargeParameterDiscoveryResType(exi_bitstream_t* stream, const struct iso2_ChargeParameterDiscoveryResType* ChargeParameterDiscoveryResType) {
    ...
    while (!done)
    {
        ...
        case 198:
            ...
            break;
        case 199:
            // Grammar: ID=199; read/write bits=3; START (SAScheduleList), START (SASchedules), START (AC_EVSEChargeParameter), START (DC_EVSEChargeParameter), START (EVSEChargeParameter)
            if (ChargeParameterDiscoveryResType->SAScheduleList_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleList, SASchedulesType); next=200
            ...
            else if (ChargeParameterDiscoveryResType->SASchedules_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (SASchedulesType); next=200
            ...
            break;
        case 200:
            // Grammar: ID=200; read/write bits=2; START (AC_EVSEChargeParameter), START (DC_EVSEChargeParameter), START (EVSEChargeParameter)
...
static int encode_iso2_PaymentDetailsReqType(exi_bitstream_t* stream, const struct iso2_PaymentDetailsReqType* PaymentDetailsReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 201:
            // Grammar: ID=201; read/write bits=1; START (eMAID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 202:
            // Grammar: ID=202; read/write bits=1; START (ContractSignatureCertChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_SessionSetupReqType(exi_bitstream_t* stream, const struct iso2_SessionSetupReqType* SessionSetupReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 203:
            // Grammar: ID=203; read/write bits=1; START (EVCCID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_AuthorizationReqType(exi_bitstream_t* stream, const struct iso2_AuthorizationReqType* AuthorizationReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 204:
            // Grammar: ID=204; read/write bits=2; START (Id), START (GenChallenge), END Element
            ...
            break;
        case 205:
            // Grammar: ID=205; read/write bits=2; START (GenChallenge), END Element
...
static int encode_iso2_ServiceDetailResType(exi_bitstream_t* stream, const struct iso2_ServiceDetailResType* ServiceDetailResType) {
    ...
    while (!done)
    {
        ...
        case 206:
            ...
            break;
        case 207:
            // Grammar: ID=207; read/write bits=1; START (ServiceID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedShort); next=208
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 208:
            // Grammar: ID=208; read/write bits=2; START (ServiceParameterList), END Element
...
static int encode_iso2_ServiceDiscoveryReqType(exi_bitstream_t* stream, const struct iso2_ServiceDiscoveryReqType* ServiceDiscoveryReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 210:
            // Grammar: ID=210; read/write bits=2; START (ServiceScope), START (ServiceCategory), END Element
            if (ServiceDiscoveryReqType->ServiceScope_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=211
            ...
            break;
        case 211:
            // Grammar: ID=211; read/write bits=2; START (ServiceCategory), END Element
...
static int encode_iso2_MeteringReceiptResType(exi_bitstream_t* stream, const struct iso2_MeteringReceiptResType* MeteringReceiptResType) {
    ...
    while (!done)
    {
        ...
        case 212:
            ...
            break;
        case 213:
            // Grammar: ID=213; read/write bits=2; START (AC_EVSEStatus), START (DC_EVSEStatus), START (EVSEStatus)
...
static int encode_iso2_PaymentDetailsResType(exi_bitstream_t* stream, const struct iso2_PaymentDetailsResType* PaymentDetailsResType) {
    ...
    while (!done)
    {
        ...
        case 216:
            ...
            break;
        case 217:
            // Grammar: ID=217; read/write bits=1; START (GenChallenge)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=218
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 218:
            // Grammar: ID=218; read/write bits=1; START (EVSETimeStamp)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_ChargeParameterDiscoveryReqType(exi_bitstream_t* stream, const struct iso2_ChargeParameterDiscoveryReqType* ChargeParameterDiscoveryReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 219:
            // Grammar: ID=219; read/write bits=2; START (MaxEntriesSAScheduleTuple), START (RequestedEnergyTransferMode)
            if (ChargeParameterDiscoveryReqType->MaxEntriesSAScheduleTuple_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MaxEntriesSAScheduleTuple, unsignedInt); next=220
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RequestedEnergyTransferMode, string); next=221
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 220:
            // Grammar: ID=220; read/write bits=1; START (RequestedEnergyTransferMode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 221:
            // Grammar: ID=221; read/write bits=2; START (AC_EVChargeParameter), START (DC_EVChargeParameter), START (EVChargeParameter)
...
static int encode_iso2_PaymentServiceSelectionReqType(exi_bitstream_t* stream, const struct iso2_PaymentServiceSelectionReqType* PaymentServiceSelectionReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 222:
            // Grammar: ID=222; read/write bits=1; START (SelectedPaymentOption)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 223:
            // Grammar: ID=223; read/write bits=1; START (SelectedServiceList)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_SessionStopReqType(exi_bitstream_t* stream, const struct iso2_SessionStopReqType* SessionStopReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 224:
            // Grammar: ID=224; read/write bits=1; START (ChargingSession)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=3
...
static int encode_iso2_ServiceDiscoveryResType(exi_bitstream_t* stream, const struct iso2_ServiceDiscoveryResType* ServiceDiscoveryResType) {
    ...
    while (!done)
    {
        ...
        case 225:
            ...
            break;
        case 226:
            // Grammar: ID=226; read/write bits=1; START (PaymentOptionList)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PaymentOptionListType); next=227
            ...
            break;
        case 227:
            // Grammar: ID=227; read/write bits=1; START (ChargeService)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (ServiceType); next=228
            ...
            break;
        case 228:
            // Grammar: ID=228; read/write bits=2; START (ServiceList), END Element
...
static int encode_iso2_MeteringReceiptReqType(exi_bitstream_t* stream, const struct iso2_MeteringReceiptReqType* MeteringReceiptReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 229:
            // Grammar: ID=229; read/write bits=2; START (Id), START (SessionID)
            if (MeteringReceiptReqType->Id_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=230
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SessionID, hexBinary); next=231
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 230:
            // Grammar: ID=230; read/write bits=1; START (SessionID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (hexBinary); next=231
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_uint_16(stream, (uint16_t)MeteringReceiptReqType->SessionID.bytesLen);
            ...
            break;
        case 231:
            // Grammar: ID=231; read/write bits=2; START (SAScheduleTupleID), START (MeterInfo)
            if (MeteringReceiptReqType->SAScheduleTupleID_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleTupleID, unsignedByte); next=232
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 232:
            // Grammar: ID=232; read/write bits=1; START (MeterInfo)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_WeldingDetectionReqType(exi_bitstream_t* stream, const struct iso2_WeldingDetectionReqType* WeldingDetectionReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 233:
            // Grammar: ID=233; read/write bits=1; START (DC_EVStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_CurrentDemandResType(exi_bitstream_t* stream, const struct iso2_CurrentDemandResType* CurrentDemandResType) {
    ...
    while (!done)
    {
        ...
        case 234:
            ...
            break;
        case 235:
            // Grammar: ID=235; read/write bits=1; START (DC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=236
            ...
            break;
        case 236:
            // Grammar: ID=236; read/write bits=1; START (EVSEPresentVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=237
            ...
            break;
        case 237:
            // Grammar: ID=237; read/write bits=1; START (EVSEPresentCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=238
            ...
            break;
        case 238:
            // Grammar: ID=238; read/write bits=1; START (EVSECurrentLimitAchieved)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 239:
            // Grammar: ID=239; read/write bits=1; START (EVSEVoltageLimitAchieved)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=240
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 240:
            // Grammar: ID=240; read/write bits=1; START (EVSEPowerLimitAchieved)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=241
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 241:
            // Grammar: ID=241; read/write bits=3; START (EVSEMaximumVoltageLimit), START (EVSEMaximumCurrentLimit), START (EVSEMaximumPowerLimit), START (EVSEID)
            if (CurrentDemandResType->EVSEMaximumVoltageLimit_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumVoltageLimit, PhysicalValueType); next=242
            ...
            else if (CurrentDemandResType->EVSEMaximumCurrentLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumCurrentLimit, PhysicalValueType); next=243
            ...
            else if (CurrentDemandResType->EVSEMaximumPowerLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumPowerLimit, PhysicalValueType); next=244
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEID, string); next=245
            ...
            break;
        case 242:
            // Grammar: ID=242; read/write bits=2; START (EVSEMaximumCurrentLimit), START (EVSEMaximumPowerLimit), START (EVSEID)
            ...
            break;
        case 243:
            // Grammar: ID=243; read/write bits=2; START (EVSEMaximumPowerLimit), START (EVSEID)
            ...
            break;
        case 244:
            // Grammar: ID=244; read/write bits=1; START (EVSEID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 245:
            // Grammar: ID=245; read/write bits=1; START (SAScheduleTupleID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=246
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 246:
            // Grammar: ID=246; read/write bits=2; START (MeterInfo), START (ReceiptRequired), END Element
            if (CurrentDemandResType->MeterInfo_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterInfo, MeterInfoType); next=247
            ...
            break;
        case 247:
            // Grammar: ID=247; read/write bits=2; START (ReceiptRequired), END Element
...
static int encode_iso2_CertificateUpdateResType(exi_bitstream_t* stream, const struct iso2_CertificateUpdateResType* CertificateUpdateResType) {
    ...
    while (!done)
    {
        ...
        case 248:
            ...
            break;
        case 249:
            // Grammar: ID=249; read/write bits=1; START (SAProvisioningCertificateChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
        ...
        case 250:
            ...
            break;
        case 251:
            // Grammar: ID=251; read/write bits=1; START (ContractSignatureEncryptedPrivateKey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (privateKeyType); next=252
            ...
            break;
        case 252:
            // Grammar: ID=252; read/write bits=1; START (DHpublickey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (dHpublickeyType); next=253
            ...
            break;
        case 253:
            // Grammar: ID=253; read/write bits=1; START (eMAID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (eMAIDType); next=254
            ...
            break;
        case 254:
            // Grammar: ID=254; read/write bits=2; START (RetryCounter), END Element
...
static int encode_iso2_CertificateInstallationReqType(exi_bitstream_t* stream, const struct iso2_CertificateInstallationReqType* CertificateInstallationReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 255:
            // Grammar: ID=255; read/write bits=1; START (Id)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (NCName); next=256
            ...
            break;
        case 256:
            // Grammar: ID=256; read/write bits=1; START (OEMProvisioningCert)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=257
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 257:
            // Grammar: ID=257; read/write bits=1; START (ListOfRootCertificateIDs)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_ChargingStatusResType(exi_bitstream_t* stream, const struct iso2_ChargingStatusResType* ChargingStatusResType) {
    ...
    while (!done)
    {
        ...
        {
        case 258:
            // Grammar: ID=258; read/write bits=1; START (ResponseCode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=259
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 260:
            ...
            break;
        case 261:
            // Grammar: ID=261; read/write bits=3; START (EVSEMaxCurrent), START (MeterInfo), START (ReceiptRequired), START (AC_EVSEStatus)
            if (ChargingStatusResType->EVSEMaxCurrent_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaxCurrent, PhysicalValueType); next=262
            ...
            else if (ChargingStatusResType->MeterInfo_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterInfo, MeterInfoType); next=263
            ...
            else if (ChargingStatusResType->ReceiptRequired_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ReceiptRequired, boolean); next=264
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 262:
            // Grammar: ID=262; read/write bits=2; START (MeterInfo), START (ReceiptRequired), START (AC_EVSEStatus)
            ...
            break;
        case 263:
            // Grammar: ID=263; read/write bits=2; START (ReceiptRequired), START (AC_EVSEStatus)
            ...
            break;
        case 264:
            // Grammar: ID=264; read/write bits=1; START (AC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=3
...
static int encode_iso2_WeldingDetectionResType(exi_bitstream_t* stream, const struct iso2_WeldingDetectionResType* WeldingDetectionResType) {
    ...
    while (!done)
    {
        ...
        case 266:
            ...
            break;
        case 267:
            // Grammar: ID=267; read/write bits=1; START (EVSEPresentVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
static int encode_iso2_SessionSetupResType(exi_bitstream_t* stream, const struct iso2_SessionSetupResType* SessionSetupResType) {
    ...
    while (!done)
    {
        ...
        case 268:
            ...
            break;
        case 269:
            // Grammar: ID=269; read/write bits=1; START (EVSEID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 270:
            // Grammar: ID=270; read/write bits=2; START (EVSETimeStamp), END Element
...
static int encode_iso2_CertificateInstallationResType(exi_bitstream_t* stream, const struct iso2_CertificateInstallationResType* CertificateInstallationResType) {
    ...
    while (!done)
    {
        ...
        case 271:
            ...
            break;
        case 272:
            // Grammar: ID=272; read/write bits=1; START (SAProvisioningCertificateChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=273
            ...
            break;
        case 273:
            // Grammar: ID=273; read/write bits=1; START (ContractSignatureCertChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=274
            ...
            break;
        case 274:
            // Grammar: ID=274; read/write bits=1; START (ContractSignatureEncryptedPrivateKey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (privateKeyType); next=275
            ...
            break;
        case 275:
            // Grammar: ID=275; read/write bits=1; START (DHpublickey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (dHpublickeyType); next=276
...
static int encode_iso2_CableCheckResType(exi_bitstream_t* stream, const struct iso2_CableCheckResType* CableCheckResType) {
    ...
    while (!done)
    {
        ...
        case 277:
            ...
            break;
        case 278:
            // Grammar: ID=278; read/write bits=1; START (DC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=279
            ...
            break;
        case 279:
            // Grammar: ID=279; read/write bits=1; START (EVSEProcessing)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=3
...
static int encode_iso2_PreChargeReqType(exi_bitstream_t* stream, const struct iso2_PreChargeReqType* PreChargeReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 280:
            // Grammar: ID=280; read/write bits=1; START (DC_EVStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=281
            ...
            break;
        case 281:
            // Grammar: ID=281; read/write bits=1; START (EVTargetVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 282:
            // Grammar: ID=282; read/write bits=1; START (EVTargetCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
static int encode_iso2_PowerDeliveryResType(exi_bitstream_t* stream, const struct iso2_PowerDeliveryResType* PowerDeliveryResType) {
    ...
    while (!done)
    {
        ...
        case 284:
            ...
            break;
        case 285:
            // Grammar: ID=285; read/write bits=2; START (AC_EVSEStatus), START (DC_EVSEStatus), START (EVSEStatus)
...
static int encode_iso2_PowerDeliveryReqType(exi_bitstream_t* stream, const struct iso2_PowerDeliveryReqType* PowerDeliveryReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 286:
            // Grammar: ID=286; read/write bits=1; START (ChargeProgress)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 287:
            // Grammar: ID=287; read/write bits=1; START (SAScheduleTupleID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=288
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 288:
            // Grammar: ID=288; read/write bits=3; START (ChargingProfile), START (DC_EVPowerDeliveryParameter), START (EVPowerDeliveryParameter), END Element
            if (PowerDeliveryReqType->ChargingProfile_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingProfile, ChargingProfileType); next=289
            ...
            break;
        case 289:
            // Grammar: ID=289; read/write bits=2; START (DC_EVPowerDeliveryParameter), START (EVPowerDeliveryParameter), END Element
...
static int encode_iso2_CertificateUpdateReqType(exi_bitstream_t* stream, const struct iso2_CertificateUpdateReqType* CertificateUpdateReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 293:
            // Grammar: ID=293; read/write bits=1; START (Id)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (NCName); next=294
            ...
            break;
        case 294:
            // Grammar: ID=294; read/write bits=1; START (ContractSignatureCertChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=295
            ...
            break;
        case 295:
            // Grammar: ID=295; read/write bits=1; START (eMAID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 296:
            // Grammar: ID=296; read/write bits=1; START (ListOfRootCertificateIDs)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (ListOfRootCertificateIDsType); next=3
...
static int encode_iso2_AuthorizationResType(exi_bitstream_t* stream, const struct iso2_AuthorizationResType* AuthorizationResType) {
    ...
    while (!done)
    {
        ...
        case 297:
            ...
            break;
        case 298:
            // Grammar: ID=298; read/write bits=1; START (EVSEProcessing)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=3
...
static int encode_iso2_CurrentDemandReqType(exi_bitstream_t* stream, const struct iso2_CurrentDemandReqType* CurrentDemandReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 299:
            // Grammar: ID=299; read/write bits=1; START (DC_EVStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=300
            ...
            break;
        case 300:
            // Grammar: ID=300; read/write bits=1; START (EVTargetCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=301
            ...
            break;
        case 301:
            // Grammar: ID=301; read/write bits=3; START (EVMaximumVoltageLimit), START (EVMaximumCurrentLimit), START (EVMaximumPowerLimit), START (BulkChargingComplete), START (ChargingComplete)
            ...
            else if (CurrentDemandReqType->EVMaximumCurrentLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumCurrentLimit, PhysicalValueType); next=303
            ...
            else if (CurrentDemandReqType->EVMaximumPowerLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumPowerLimit, PhysicalValueType); next=304
            ...
            else if (CurrentDemandReqType->BulkChargingComplete_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (BulkChargingComplete, boolean); next=305
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingComplete, boolean); next=306
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 302:
            // Grammar: ID=302; read/write bits=3; START (EVMaximumCurrentLimit), START (EVMaximumPowerLimit), START (BulkChargingComplete), START (ChargingComplete)
            ...
            break;
        case 303:
            // Grammar: ID=303; read/write bits=2; START (EVMaximumPowerLimit), START (BulkChargingComplete), START (ChargingComplete)
            ...
            break;
        case 304:
            // Grammar: ID=304; read/write bits=2; START (BulkChargingComplete), START (ChargingComplete)
            ...
            break;
        case 305:
            // Grammar: ID=305; read/write bits=1; START (ChargingComplete)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 306:
            // Grammar: ID=306; read/write bits=2; START (RemainingTimeToFullSoC), START (RemainingTimeToBulkSoC), START (EVTargetVoltage)
            if (CurrentDemandReqType->RemainingTimeToFullSoC_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RemainingTimeToFullSoC, PhysicalValueType); next=307
            ...
            else if (CurrentDemandReqType->RemainingTimeToBulkSoC_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RemainingTimeToBulkSoC, PhysicalValueType); next=308
            ...
            break;
        case 307:
            // Grammar: ID=307; read/write bits=2; START (RemainingTimeToBulkSoC), START (EVTargetVoltage)
            ...
            break;
        case 308:
            // Grammar: ID=308; read/write bits=1; START (EVTargetVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
