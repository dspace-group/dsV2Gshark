...
static inline const char* get_enum_val_iso20_ac_evseNotificationType_reverse(int i)
{
    if (i == 0) { return "Pause"; }
...
static inline const char* get_enum_val_iso20_ac_responseCodeType_reverse(int i)
{
    if (i == 0) { return "OK"; }
